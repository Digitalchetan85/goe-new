...
try {
    ...
    $mail->isHTML(true);                                  // Set email format to HTML
        ...
        $mail->Body   .= "<tr style='background: #eee;'><td><strong>Online Enquery:</strong> </td><td>" . 'Free Councelling Country Page' . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Student Name:</strong> </td><td>" . strip_tags($_POST['student-name']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Parent Name:</strong> </td><td>" . strip_tags($_POST['parent-name']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Email:</strong> </td><td>" . strip_tags($_POST['email']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Phone:</strong> </td><td>" . strip_tags($_POST['tel']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>City:</strong> </td><td>" . strip_tags($_POST['city']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>NEET Score:</strong> </td><td>" . strip_tags($_POST['neet']) . "</td></tr>";
        $mail->Body   .= "</table>";
        $mail->Body   .= "</body></html>";
