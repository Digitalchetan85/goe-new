...
<html lang="en">
  <head>
    ...
    <meta name="title" content="Davao Medical College | MBBS in Philippines | GOE">
    <meta name="description" content="Davao Medical College is one of the best medical university to Study MBBS in Philippines. GOE helps to get the MBBS Admission in Davao Medical College .">
    ...
    <meta property="og:url" content="https://glowoverseas.com/mbbs-in-philippines/davao-medical-college.php">
    <meta property="og:title" content="Davao Medical College | MBBS in Philippines | GOE">
    <meta property="og:description" content="Davao Medical College is one of the best medical university to Study MBBS in Philippines. GOE helps to get the MBBS Admission in Davao Medical College .">
    <meta property="og:image" content="">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://glowoverseas.com/mbbs-in-philippines/davao-medical-college.php">
    <meta property="twitter:title" content="Davao Medical College | MBBS in Philippines | GOE">
    <meta property="twitter:description" content="Davao Medical College is one of the best medical university to Study MBBS in Philippines. GOE helps to get the MBBS Admission in Davao Medical College .">
    <meta property="twitter:image" content="">

    <!-- Favicon -->
    <link rel="icon" href="../images/favicon.png">
    <link rel="canonical" href="https://glowoverseas.com/mbbs-in-philippines/davao-medical-college.php" />
                    ...
                    <div class="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item"><a href="../mbbs-in-philippines.php">MBBS in Philippines</a></li>
                              <li class="breadcrumb-item active" aria-current="page">Davao Medical College</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="container">
                        <div class="border p-2 m-1">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="text-center">Davao Medical College</h3>
                                </div>
                            </div>
                            <div class="row pt-2">
                                <div class="col-md-6">
                                    <div class="university">
                                        <p class="text-justify pb-2">
                                            Davao Medical School of Foundation is one of the largest medical universities in the Philippines teaching MBBS to students from both Philippines and abroad. It is recognized by WHO, MCI, and many more international professional groups. Davao Medical School of Foundation has formed into a huge scale, a well-managed comprehensive university with good MBBS teaching staff. It is one of those universities which is having an advanced system of education, and it trains students with the help of updated education technology of medical study. The university embraces the high-tech methods of practical medicine that empower MBBS students to be focused, competitive and flexible in the world market.
                                        </p>
                                        <ul>
                                            <li>Established in 1975</li>
                        ...
                        <div class="top-medical-university pt-5 pb-5">
                                ...
                                <div class="col-md-12">
                                    <div class="university">
                                        ...
                                        <p class="text-justify">
                                            Study MBBS in Philippines at Davao Medical College an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div class="text-center">
                                            <<?php include '../templates/university-free-councelling.php' ?>
                                        </div>
                            ...
                            <div class="row pt-5">
                                <div class="col-md-12">
                                    <div class="university">
                                        <h5 class="text-center pb-5">Admission Process for MBBS in Philippines</h5>
                                        <div class="text-center">
                            ...
                            <div class="row pt-5">
                                <div class="col-md-6">
                                    <div class="university">
                                        <h4 class="text-center">Other Top Medical Universities in Philippines</h4>
